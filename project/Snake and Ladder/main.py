        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if Dice.goti_number() and turn == "red":
                    turn = "blue"
                    # for red goti
                    if diceroll == 1 and rx == 370 and ry == 300 and cnt1 is None:
                        rx = 300
                        ry = 584
                        cnt1 = 0
                    elif cnt1 is not None and (cnt1 + diceroll) == 100:
                        cnt1 += diceroll
                        ...
                        continue
                    elif cnt1 is not None and diceroll == 1:
                        cnt1 += diceroll
                        ...
                        rx = a[0]
                        ry = a[1]
                    elif cnt1 is not None and diceroll == 2:
                        cnt1 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt1, con1)
                        if condition1:
                            cnt1 = lddr
                        ...
                        rx = a[0]
                        ry = a[1]
                    elif cnt1 is not None and diceroll == 3:
                        cnt1 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt1, con1)
                        if condition1:
                            cnt1 = lddr
                        ...
                        rx = a[0]
                        ry = a[1]
                    elif cnt1 is not None and diceroll == 4:
                        cnt1 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt1, con1)
                        if condition1:
                            cnt1 = lddr
                        ...
                        rx = a[0]
                        ry = a[1]
                    elif cnt1 is not None and diceroll == 5:
                        cnt1 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt1, con1)
                        if condition1:
                            cnt1 = lddr
                        ...
                        rx = a[0]
                        ry = a[1]
                    elif cnt1 is not None and diceroll == 6:
                        cnt1 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt1, con1)
                        if condition1:
                            cnt1 = lddr
                ...
                # for blue goti
                    ...
                    turn = "red"
                    if diceroll == 1 and bx == 370 and by ==450 and cnt2 is None:
                        bx = 351
                        by = 584
                        cnt2 = 0
                    elif cnt2 is not None and (cnt2 + diceroll) == 100:
                        cnt2 += diceroll
                        ...
                        continue
                    elif cnt2 is not None and diceroll == 1:
                        cnt2 += diceroll
                        ...
                        bx = a[0]
                        by = a[1]
                    elif cnt2 is not None and diceroll == 2:
                        cnt2 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt2, con1)
                        if condition1:
                            cnt2 = lddr
                        ...
                        bx = a[0]
                        by = a[1]
                    elif cnt2 is not None and diceroll == 3:
                        cnt2 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt2, con1)
                        if condition1:
                            cnt2 = lddr
                        ...
                        bx = a[0]
                        by = a[1]
                    elif cnt2 is not None and diceroll == 4:
                        cnt2 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt2, con1)
                        if condition1:
                            cnt2 = lddr
                        ...
                        bx = a[0]
                        by = a[1]
                    elif cnt2 is not None and diceroll == 5:
                        cnt2 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt2, con1)
                        if condition1:
                            cnt2 = lddr
                        ...
                        bx = a[0]
                        by = a[1]
                    elif cnt2 is not None and diceroll == 6:
                        cnt2 += diceroll
                        lddr, condition1 = Ladders.ladder(cnt2, con1)
                        if condition1:
                            cnt2 = lddr
